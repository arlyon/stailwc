...
#[test_case(r#"<Test tw="h-4" />"#, r#"<Test css={{height: "1rem"}} />"#, Engine::Emotion ; "basic")]
#[test_case(r#"<Test tw={"h-4"} />"#, r#"<Test css={{height: "1rem"}} />"#, Engine::Emotion ; "string")]
#[test_case(r#"const x = tw`h-4`"#, r#"const x = {height: "1rem"}"#, Engine::Emotion ; "template")]
#[test_case(r#"<Test css={tw`h-4`} />"#, r#"<Test css={{height: "1rem"}} />"#, Engine::Emotion ; "template_jsx")]
#[test_case(r#"<Test tw="h-4" css={{width: "1rem"}} />"#, r#"<Test css={[{width: "1rem"}, {height: "1rem"}]} />"#, Engine::Emotion ; "existing_css_object")]
#[test_case(r#"<Test tw="h-4" css={[]} />"#, r#"<Test css={[{height: "1rem"}]} />"#, Engine::Emotion ; "existing_css_array")]
#[test_case(
    // Input codes
    r#"<Test tw="hover:h-4 hover:text-black" />"#,
    // Output codes after transformed with plugin
    r#"<Test css={{":hover": {height: "1rem", "--tw-text-opacity": "1", color: "black"}}} />"#,
    Engine::Emotion
    ; "multiple modifiers"
)]
#[test_case(
...
"#, Engine::Emotion ; "emotion global style")]
#[test_case(
    r#"
import { TailwindStyle } from "stailwc";
...
"#, Engine::StyledComponents ; "styled components"
)]
#[test_case(    r#"
...
"#, Engine::Emotion ; "emotion component native")]
#[test_case(    r#"
...
"#, Engine::Emotion ; "emotion component extend")]
#[test_case(r#"
const Red = tw.button`text-red-500`
const Button = tw(Red)`bg-black`
"#, r#"
...
const Button = _styled(Red)({
    "--tw-bg-opacity": "1",
    backgroundColor: "black"
});"#, Engine::StyledComponents ; "styled components component extend")]
#[test_case(r#"tw.button`text-red-500`"#,  r#"
_styled.button({
        "--tw-text-opacity": "1",
        color: "red"
});"#, Engine::StyledComponents ; "styled components component native")]
fn test(input: &str, output: &str, engine: Engine) {
    let mut ac: TailwindConfig = Default::default();
    ac.theme.height.insert("4", "1rem");
    ac.theme.spacing.insert("4", "1rem");
    ac.theme.colors.insert("black", "black");
    ac.theme.colors.insert("red-500", "red");
    ac.theme.margin.insert("4", "1rem");
    ac.theme.screens.insert("lg", Screens::Min("1024px"));

    run_test(input, output, engine, &ac);
}
...
pub fn snapshot_inner(input: &str, expected: &str) {
    let config = CONFIG;
    run_test(input, expected, Engine::Emotion, &config)
}

pub fn run_test(input: &str, expected: &str, engine: Engine, config: &TailwindConfig) {
    test_transform(
        Syntax::Es(EsConfig {
            jsx: true,
            ..Default::default()
